...
import (
	...
	"github.com/stormasm/nomsredis/go/perf/suite"
	"github.com/stormasm/nomsredis/go/types"
	"github.com/stormasm/nomsredis/samples/go/csv"
...
func (s *perfSuite) SetupSuite() {
	...
	err := exec.Command("go", "build", "-o", s.csvImportExe, "github.com/stormasm/nomsredis/samples/go/csv/csv-import").Run()
