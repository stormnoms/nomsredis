...
import (
	...
	"github.com/stormasm/nomsredis/cmd/noms/diff"
	...
	"github.com/stormasm/nomsredis/go/util/orderedparallel"
	"github.com/stormasm/nomsredis/go/util/outputpager"
	"github.com/stormasm/nomsredis/go/util/verbose"
	"github.com/stormasm/nomsredis/go/util/writers"
...
var nomsLog = &util.Command{
	...
	Long:      "commitObject must be a dataset or object spec that refers to a commit. See Spelling Objects at https://github.com/stormasm/nomsredis/blob/master/doc/spelling.md for details.",
	Flags:     setupLogFlags,
	Nargs:     1,
}
